...
PAGES = [
    ...
    ("ejercicios/01-salida.md", "b1", "B1 · Salida con pivote (T1–5)", "Práctica"),
    ("ejercicios/02-medio-de-3.md", "b2", "B2 · Mediocampo de 3 (T6–9)", "Práctica"),
    ("ejercicios/03-pressing.md", "b3", "B3 · Pressing del tridente (T10–13)", "Práctica"),
    ("ejercicios/04-tridente-amplitud.md", "b4", "B4 · Tridente y amplitud (T14–18)", "Práctica"),
    ("ejercicios/05-llegada-finalizacion.md", "b5", "B5 · Llegada y finalización (T19–22)", "Práctica"),
...
def main():
    ...
    nav = ['<a class="brand" href="#inicio">⚽ Curso 1-4-3-3<small>MISTER ÉLITE · MOISÉS DÍAZ</small></a>']
    for sec in order:
...
<title>Curso 1-4-3-3 · MISTER ÉLITE</title><style>{CSS}</style></head><body>
<button id="menu-btn">☰</button>
<div class="layout"><nav class="side">{nav_html}</nav>
<main class="content"><div class="inner">{''.join(parts)}
<footer class="foot">Curso "Sistema 1-4-3-3: del concepto al campo" · MISTER ÉLITE — Moisés Díaz</footer>
</div></main></div>
...
document.querySelectorAll('.side a').forEach(a=>a.onclick=()=>s.classList.remove('open'));</script>
    ...
    out = os.path.join(ROOT, "curso-1433-completo.html")
