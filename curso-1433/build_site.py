#!/usr/bin/env python3
"""Construye una versión HTML navegable del curso 1-4-3-3 a partir de los .md.
Salida: curso-1433/site/  (abrir site/index.html)."""
...
PAGES = [
    ...
    ("ejercicios/01-salida.md", "ejercicios/01-salida.html", "B1 · Salida con pivote (T1–5)", "Práctica"),
    ("ejercicios/02-medio-de-3.md", "ejercicios/02-medio-de-3.html", "B2 · Mediocampo de 3 (T6–9)", "Práctica"),
    ("ejercicios/03-pressing.md", "ejercicios/03-pressing.html", "B3 · Pressing del tridente (T10–13)", "Práctica"),
    ("ejercicios/04-tridente-amplitud.md", "ejercicios/04-tridente-amplitud.html", "B4 · Tridente y amplitud (T14–18)", "Práctica"),
    ("ejercicios/05-llegada-finalizacion.md", "ejercicios/05-llegada-finalizacion.html", "B5 · Llegada y finalización (T19–22)", "Práctica"),
...
def build_nav(current_out, prefix):
    ...
    parts.append(f'<a class="brand" href="{prefix}index.html">⚽ Curso 1-4-3-3</a>')
    for sec in order:
...
<title>{title} · Curso 1-4-3-3</title>
...
{body}
<footer class="foot">Curso "Sistema 1-4-3-3: del concepto al campo" · MISTER ÉLITE — Moisés Díaz · poca teoría, mucha práctica</footer>
</div>
</main>
</div>
<script>
    ...
    for src, out, title, sec in PAGES:
        ...
        if out == "index.html":
            body = (f'<img class="hero" src="{prefix}graficos/portada.svg" '
                    f'alt="Curso 1-4-3-3 · MISTER ÉLITE">' + body)
