...
def t14():
    ...
    # servidores 6 y 8 detrás
    p.player(32, 54, "6", team="own")
    p.player(62, 54, "8", team="own")
    p.ball(32, 54)
...
def t15():
    ...
    p.arrow(43, 56, 79, 44, kind="pass", label="3 al extremo")
...
def t17():
    ...
    p.player(26, 56, "8", team="own", role="rechace", role_below=True)
    p.arrow(28, 58, 38, 76, kind="run")
...
def t19():
    ...
    p.player(74, 72, "7", team="own", role="fija por dentro")
    # lateral aparece por fuera
    p.player(92, 66, "2", team="own", role="desborda")
    p.ball(74, 72)
    # apoyo interior 8
...
def t20():
    ...
    p.player(84, 74, "7", team="own")
    p.player(92, 62, "2", team="own", role="centra", role_below=True)
    p.ball(92, 62)
...
def t22():
    ...
    p.arrow(31, 55, 56, 67, kind="pass", label="1")
...
def t24():
    ...
    p.arrow(46, 47, 56, 61, kind="pass", label="o al 9")
...
def t25():
    ...
    p.arrow(22, 70, 22, 56, kind="run", label="3 baja")
    p.arrow(78, 70, 78, 56, kind="run", label="3 baja")
...
def t26():
    ...
    p.zone(34, 58, 66, 80, label="", ellipse=True)
    p.note(50, 76, "robo 9+10 = +1")
