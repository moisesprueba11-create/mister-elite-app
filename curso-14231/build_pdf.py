#!/usr/bin/env python3
"""Genera un PDF unico del curso 1-4-2-3-1 (textos + pizarras) -> curso-14231.pdf"""
import os, re, html
import markdown
...
DOCS = [
    ...
    ("ejercicios/01-salida.md", "BLOQUE 1 · Salida 2 centrales + doble pivote"),
    ("ejercicios/02-doble-pivote.md", "BLOQUE 2 · Doble pivote y mutación"),
    ("ejercicios/03-pressing.md", "BLOQUE 3 · Pressing de la dupla 9+10"),
    ("ejercicios/04-mediapunta.md", "BLOQUE 4 · La mediapunta entre líneas"),
    ("ejercicios/05-extremos-laterales.md", "BLOQUE 5 · Extremos, laterales y 9"),
    ("ejercicios/06-transiciones-partido.md", "BLOQUE 6 · Transiciones y partido"),
]
...
@page{size:A4;margin:1.8cm 1.6cm;
 @bottom-center{content:"Sistema 1-4-2-3-1 · del concepto al campo · MISTER ÉLITE";font-size:8pt;color:#999;}
...
def main():
    ...
    out = os.path.join(ROOT, "curso-14231.pdf")
