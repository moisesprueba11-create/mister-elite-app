#!/usr/bin/env python3
"""Genera un PDF unico del curso de Pretemporada (textos + infografías) -> curso-pretemporada.pdf"""
import os, re, html
...
DOCS = [
    ("README.md", None),
    ("modulos/01-fundamentos.md", "MÓDULO 01 · Fundamentos de la pretemporada"),
    ...
    ("ejercicios/03-plan-5-sesiones.md", "PLAN · 5 sesiones"),
    ("ejercicios/04-plan-4-sesiones.md", "PLAN · 4 sesiones"),
...
@page{size:A4;margin:1.8cm 1.6cm;
 @bottom-center{content:"Pretemporada perfecta · MISTER ÉLITE — Moisés Díaz";font-size:8pt;color:#999;}
...
def main():
    ...
    out = os.path.join(ROOT, "curso-pretemporada.pdf")
