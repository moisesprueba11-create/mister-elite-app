...
**Teoría (4 módulos) — el porqué:**
1. **Fundamentos** — qué es y qué NO es la pretemporada, sus fases y los modelos de periodización.
...
1. Lee los **4 módulos de teoría** (una tarde). No necesitas dominarlos, solo entender las ideas.
2. Ve al **Mapa de decisión** y localiza tu nivel de frecuencia.
3. Abre **tu plan** y cópialo a tus fechas reales (cuántas semanas tienes hasta el debut).
4. Rellena cada sesión con el **banco de sesiones** según el contenido del día.
5. Controla la carga con las **herramientas** y ajusta sobre la marcha.
