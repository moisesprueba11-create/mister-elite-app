#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Genera UN SOLO archivo HTML autocontenido (SVG + CSS embebidos) -> curso-pretemporada-completo.html"""
import os, re, html
import markdown
...
PAGES = [
    ...
    ("ejercicios/03-plan-5-sesiones.md", "p3", "Plan · 5 sesiones", "Planes"),
    ("ejercicios/04-plan-4-sesiones.md", "p4", "Plan · 4 sesiones", "Planes"),
    ("ejercicios/05-plan-3-sesiones.md", "p5", "Plan · 3 sesiones", "Planes"),
    ("ejercicios/06-plan-2-sesiones.md", "p6", "Plan · 2 sesiones", "Planes"),
    ("ejercicios/07-banco-sesiones.md", "banco", "Banco de 12 sesiones", "Práctica"),
    ("ejercicios/09-programacion-6-semanas.md", "prog", "Programación 6 semanas", "Práctica"),
    ("ejercicios/08-herramientas.md", "tools", "Herramientas de control", "Práctica"),
]
...
def main():
    ...
    nav = ['<a class="brand" href="#inicio">📋 Pretemporada perfecta<small>MISTER ÉLITE · MOISÉS DÍAZ</small></a>']
    for sec in order:
...
<title>Pretemporada perfecta · MISTER ÉLITE</title><style>{CSS}</style></head><body>
<button id="menu-btn">☰</button>
<div class="layout"><nav class="side">{nav_html}</nav>
<main class="content"><div class="inner">{''.join(parts)}
<footer class="foot">Curso "Pretemporada perfecta" · MISTER ÉLITE — Moisés Díaz</footer>
</div></main></div>
...
document.querySelectorAll('.side a').forEach(a=>a.onclick=()=>s.classList.remove('open'));</script>
    ...
    out = os.path.join(ROOT, "curso-pretemporada-completo.html")
