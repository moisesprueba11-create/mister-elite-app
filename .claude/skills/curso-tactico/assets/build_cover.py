...
CONFIG = dict(
    ...
    footer_left="Salida · Presión · Basculación · Transiciones · Balón parado",
    stats=[("4", "módulos de teoría"), ("27", "tareas de campo"),
           ("+40", "pizarras tácticas"), ("2", "microciclos modelo")],
    gk=1,                          # dorsal del portero
    lines=[[3, 5, 4, 2],           # defensa (izq->der en pantalla)
           [6, 8, 10],             # medio
           [7, 9, 11]],            # delantera (extremos + 9); los de arriba llevan flecha de ataque
)
