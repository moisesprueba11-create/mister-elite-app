#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Genera UN SOLO archivo HTML autocontenido (SVG + CSS embebidos) -> curso-ruedas-completo.html"""
import os, re, html
import markdown
...
PAGES = [
    ...
    ("modulos/02-principios-tecnicos.md", "m02", "M02 · Principios técnicos", "Teoría"),
    ("modulos/03-organizar-progresar.md", "m03", "M03 · Organizar y progresar", "Teoría"),
    ("modulos/04-del-patron-al-juego.md", "m04", "M04 · Del patrón al juego", "Teoría"),
    ("ejercicios/00-como-usar.md", "uso", "Cómo usar el banco", "Práctica"),
    ("ejercicios/01-basicas.md", "f1", "F1 · Básicas (01–05)", "Práctica"),
    ("ejercicios/02-movilidad.md", "f2", "F2 · Movilidad (06–10)", "Práctica"),
    ("ejercicios/03-tercer-hombre.md", "f3", "F3 · Pared y tercer hombre (11–15)", "Práctica"),
    ("ejercicios/04-progresion.md", "f4", "F4 · Progresión (16–20)", "Práctica"),
    ("ejercicios/05-finalizacion.md", "f5", "F5 · Finalización (21–25)", "Práctica"),
    ("ejercicios/06-oposicion.md", "f6", "F6 · Oposición (26–30)", "Práctica"),
]
...
def main():
    ...
    nav = ['<a class="brand" href="#inicio">📋 Ruedas de pases<small>MISTER ÉLITE · MOISÉS DÍAZ</small></a>']
    for sec in order:
...
<title>Ruedas de pases · MISTER ÉLITE</title><style>{CSS}</style></head><body>
...
document.querySelectorAll('.side a').forEach(a=>a.onclick=()=>s.classList.remove('open'));</script>
    ...
    out = os.path.join(ROOT, "curso-ruedas-completo.html")
