#!/usr/bin/env python3
"""Construye una versión HTML navegable del curso de Ruedas de pases a partir de los .md.
Salida: curso-ruedas/site/  (abrir site/index.html)."""
...
PAGES = [
    ...
    ("modulos/02-principios-tecnicos.md", "modulos/02-principios-tecnicos.html", "M02 · Principios técnicos", "Teoría"),
    ("modulos/03-organizar-progresar.md", "modulos/03-organizar-progresar.html", "M03 · Organizar y progresar", "Teoría"),
    ("modulos/04-del-patron-al-juego.md", "modulos/04-del-patron-al-juego.html", "M04 · Del patrón al juego", "Teoría"),
    ("ejercicios/00-como-usar.md", "ejercicios/00-como-usar.html", "Cómo usar el banco", "Práctica"),
    ("ejercicios/01-basicas.md", "ejercicios/01-basicas.html", "F1 · Básicas (01–05)", "Práctica"),
    ("ejercicios/02-movilidad.md", "ejercicios/02-movilidad.html", "F2 · Movilidad (06–10)", "Práctica"),
    ("ejercicios/03-tercer-hombre.md", "ejercicios/03-tercer-hombre.html", "F3 · Pared y tercer hombre (11–15)", "Práctica"),
    ("ejercicios/04-progresion.md", "ejercicios/04-progresion.html", "F4 · Progresión (16–20)", "Práctica"),
    ("ejercicios/05-finalizacion.md", "ejercicios/05-finalizacion.html", "F5 · Finalización (21–25)", "Práctica"),
    ("ejercicios/06-oposicion.md", "ejercicios/06-oposicion.html", "F6 · Oposición (26–30)", "Práctica"),
]
...
def build_nav(current_out, prefix):
    ...
    parts.append(f'<a class="brand" href="{prefix}index.html">📋 Ruedas de pases</a>')
    for sec in order:
...
<title>{title} · Ruedas de pases</title>
...
{body}
<footer class="foot">Curso "Ruedas de pases" · MISTER ÉLITE — Moisés Díaz</footer>
</div>
</main>
</div>
<script>
    ...
    for src, out, title, sec in PAGES:
        ...
        if out == "index.html":
            body = (f'<img class="hero" src="{prefix}graficos/portada.svg" '
                    f'alt="Ruedas de pases · MISTER ÉLITE">' + body)
