...
![DIAGRAMA: tarea 10 — los dos DC presionan en pareja con carrera curvada; el primero tapa la sombra al pivote, el segundo cubre el central libre, salida rival orientada hacia la zona-meta de banda](../graficos/16-tarea-press-delanteros.svg)
...
![DIAGRAMA: tarea 11 — el balón pasa del central al lateral rival (gatillo); el MD salta al lateral, el DC cierra la vuelta al central, el MC tapa el interior y el lateral propio sube a vigilar al extremo rival](../graficos/17-tarea-gatillo-lateral.svg)
