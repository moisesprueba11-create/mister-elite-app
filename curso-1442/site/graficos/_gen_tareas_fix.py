...
def tarea_05():
    ...
    p.player(20, 64, "EI", team="own")
    p.player(33, 64, "MC", team="own")
    p.player(46, 64, "MC", team="own")
    p.player(60, 64, "ED", team="own")
...
def tarea_06():
    ...
    # Línea de medios (4)
    p.player(22, 70, "EI", team="own")
    p.player(38, 73, "MC", team="own")
    p.player(58, 73, "MC", team="own")
    p.player(78, 70, "ED", team="own")
...
def tarea_24():
    ...
    p.player(90, 58, "ED", team="own")
    p.player(11, 50, "EI", team="own")
