#!/usr/bin/env python3
"""Genera un PDF unico del curso 1-5-3-2 (textos + pizarras) -> curso-1532.pdf"""
import os, re, html
import markdown
...
DOCS = [
    ...
    ("ejercicios/01-salida.md", "BLOQUE 1 · Salida de balón con 3 centrales + pivote"),
    ("ejercicios/02-linea5.md", "BLOQUE 2 · Línea de 5 y basculación"),
    ("ejercicios/03-pressing.md", "BLOQUE 3 · Press de los 2 DC y gatillo del carrilero"),
    ("ejercicios/04-carrileros.md", "BLOQUE 4 · Doble función de los carrileros"),
    ("ejercicios/05-delanteros-interiores.md", "BLOQUE 5 · Delanteros e interiores"),
    ("ejercicios/06-transiciones-partido.md", "BLOQUE 6 · Transiciones y partido condicionado"),
]
...
@page{size:A4;margin:1.8cm 1.6cm;
 @bottom-center{content:"Sistema 1-5-3-2 · del concepto al campo";font-size:8pt;color:#999;}
...
def main():
    ...
    out = os.path.join(ROOT, "curso-1532.pdf")
