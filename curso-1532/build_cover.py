...
CONFIG = dict(
    ...
    footer_left="Línea de 5 · Carrileros · Presión · Transiciones · Balón parado",
    stats=[("4", "módulos de teoría"), ("26", "tareas de campo"),
           ("+40", "pizarras tácticas"), ("2", "microciclos modelo")],
    gk=1,                          # dorsal del portero
    lines=[[3, 6, 5, 4, 2],        # defensa de 5 (izq->der): CARI, DFCizq, líbero, DFCder, CARD
           [10, 8, 7],             # medio de 3: interior izq, pivote, interior der
           [9, 11]],               # delantera: 2 puntas
)
