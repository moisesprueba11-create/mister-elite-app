#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Genera UN SOLO archivo HTML autocontenido (SVG + CSS embebidos) -> curso-bp-defensivo-completo.html"""
import os, re, html
import markdown
...
PAGES = [
    ...
    ("modulos/02-sistemas-marcaje.md", "m02", "M02 · Sistemas de marcaje", "Teoría"),
    ("ejercicios/00-como-defender.md", "uso", "Cómo defender", "Práctica"),
    ("ejercicios/01-corner.md", "corner", "Córners", "Práctica"),
    ("ejercicios/02-faltas.md", "faltas", "Faltas", "Práctica"),
    ("ejercicios/03-saques-banda.md", "saques", "Saques de banda", "Práctica"),
]
...
def main():
    ...
    nav = ['<a class="brand" href="#inicio">🛡️ Balón parado defensivo<small>MISTER ÉLITE · MOISÉS DÍAZ</small></a>']
    for sec in order:
...
<title>Balón parado defensivo · MISTER ÉLITE</title><style>{CSS}</style></head><body>
...
document.querySelectorAll('.side a').forEach(a=>a.onclick=()=>s.classList.remove('open'));</script>
    ...
    out = os.path.join(ROOT, "curso-bp-defensivo-completo.html")
