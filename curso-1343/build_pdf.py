#!/usr/bin/env python3
"""Genera un PDF unico del curso 1-3-4-3 (textos + pizarras) -> curso-1343.pdf"""
import os, re, html
...
DOCS = [
    ...
    ("ejercicios/01-salida.md", "BLOQUE 1 · Salida con 3 centrales + pivote"),
    ("ejercicios/02-linea5.md", "BLOQUE 2 · Línea de 3 ↔ línea de 5"),
    ("ejercicios/03-pressing.md", "BLOQUE 3 · Pressing del tridente"),
    ("ejercicios/04-carrileros.md", "BLOQUE 4 · Carrileros y mutación"),
    ("ejercicios/05-tridente.md", "BLOQUE 5 · Tridente"),
...
@page{size:A4;margin:1.8cm 1.6cm;
 @bottom-center{content:"Sistema 1-3-4-3 · del concepto al campo";font-size:8pt;color:#999;}
...
def main():
    ...
    out = os.path.join(ROOT, "curso-1343.pdf")
