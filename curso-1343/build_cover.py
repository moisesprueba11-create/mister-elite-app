...
CONFIG = dict(
    ...
    footer_left="Tres centrales · Carrileros · Tridente · Presión · Transiciones",
    stats=[("4", "módulos de teoría"), ("26", "tareas de campo"),
           ("+40", "pizarras tácticas"), ("2", "microciclos modelo")],
    gk=1,
    lines=[[6, 5, 4],          # defensa de 3: DFCizq, líbero, DFCder
           [3, 10, 8, 2],      # medio de 4: CAR izq, MC, MC, CAR der
           [11, 9, 7]],        # tridente: EI, DC, ED
)
