#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Genera UN SOLO archivo HTML autocontenido (SVG + CSS embebidos) -> curso-1343-completo.html"""
import os, re, html
import markdown
...
PAGES = [
    ...
    ("ejercicios/01-salida.md", "b1", "B1 · Salida (T1.1–1.5)", "Práctica"),
    ("ejercicios/02-linea5.md", "b2", "B2 · Línea de 5 (T2.1–2.4)", "Práctica"),
    ("ejercicios/03-pressing.md", "b3", "B3 · Pressing (T3.1–3.4)", "Práctica"),
    ("ejercicios/04-carrileros.md", "b4", "B4 · Carrileros y mutación (T4.1–4.5)", "Práctica"),
    ("ejercicios/05-tridente.md", "b5", "B5 · Tridente (T5.1–5.4)", "Práctica"),
    ("ejercicios/06-transiciones-partido.md", "b6", "B6 · Transiciones y partido (T6.1–6.4)", "Práctica"),
]
...
def main():
    ...
    nav = ['<a class="brand" href="#inicio">⚽ Curso 1-3-4-3<small>MISTER ÉLITE · MOISÉS DÍAZ</small></a>']
    for sec in order:
...
<title>Curso 1-3-4-3 · MISTER ÉLITE</title><style>{CSS}</style></head><body>
<button id="menu-btn">☰</button>
<div class="layout"><nav class="side">{nav_html}</nav>
<main class="content"><div class="inner">{''.join(parts)}
<footer class="foot">Curso "Sistema 1-3-4-3: del concepto al campo" · MISTER ÉLITE — Moisés Díaz</footer>
</div></main></div>
...
document.querySelectorAll('.side a').forEach(a=>a.onclick=()=>s.classList.remove('open'));</script>
    ...
    out = os.path.join(ROOT, "curso-1343-completo.html")
